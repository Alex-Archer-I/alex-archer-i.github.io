...
overlayArray[1] = new OverlayText('Giraffes only sleep around 20 minutes or less per day', 'Now you learn more!', 'Wonderfull!', '.learning');
...
$(document).ready(function()
{
    ...
    $('.faq_icon').click(function()
    {
        ...
        $(this).closest('.faq_question').next('.faq_answer').slideToggle();
        $(this).toggleClass('open');
    });

    $('.button').click(function()
    {
        if(!$(this).is('.overlay_button'))
        {
            $('.overlay').fadeIn('slow');
